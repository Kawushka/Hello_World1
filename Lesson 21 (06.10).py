...
class Calculator(QWidget):
    ...
    def initUI(self):
        self.setGeometry(300, 300, 220, 350) #координаты углов окна приложение, X,Y, ширина, высота
        ...
        self.integer_division.move(110, 300)
        ...
        self.exponentiation.move(55, 300)
...
#ВОПРОСЫ:
# 1. как после получения результата по нажатию равно обнулить label при новом вводе цифр без нажатия на C?
# 2. как ввести не целое число? Не понимаю логику... понимаю, что списком с проверкой, была ли уже введена ".", но не понимаю,
# как это сделать)
